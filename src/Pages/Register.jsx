            ...
            createNewUser(email, password)
              .then((result) => {
                ...
                if (result.user) {
                  ...
                  axiosPublic
                    .post("/createNewUser", newUserInfo)
                    .then((res) => {
                      const data = res.data;
                      if (data.insertedId) {
    ...
    >
      <div className="container mx-auto py-[100px] md:py-10 px-5 lg:p-10 flex flex-col justify-center items-center gap-5">
        <CenteredSectionTitle
          smallText={"Free Registration"}
          bigText={"Join Caffeine Now"}
        />
        ...
        >
          ...
          <input
            ...
            className="w-full bg-[#00000000] border-b-[1px] px-5 py-3 border-lightBlack focus:outline-none focus:border-white text-lightWhite"
          />
          ...
          <input
            ...
            className="w-full bg-[#00000000] border-b-[1px] px-5 py-3 border-lightBlack focus:outline-none focus:border-white text-white"
          />
          ...
          <div className="w-full">
            <div className="flex relative w-full justify-center items-center">
              ...
              <span
                ...
                className="absolute right-2 text-lightWhite"
              >
                {" "}
          ...
          >
            <FaUpload className="text-[#9CA3AF]" />{" "}
          ...
          <input
            type="submit"
            value="Register now"
            className="w-full bg-second text-white px-5 py-2 hover:bg-third duration-500 cursor-pointer"
          />
        </form>

        {/* login page toggle */}
        <div className="mt-5 flex justify-center items-center gap-4">
          <p className="text-center font-medium text-lightWhite">
            Already have an account?
          </p>
          <Link
            to="/signIn"
            className="font-semibold text-white border-b-2 border-white hover:text-second py-1 hover:border-second duration-300"
          >
            Sign In
          </Link>
        </div>
        ...
        <Link
          to="/"
          className="absolute top-10 left-5 lg:left-10 flex justify-center items-center gap-2 text-[18px] font-body hover:text-second duration-500 hover:scale-105"
        >
          <MdHome />
          Back to Home
        </Link>
