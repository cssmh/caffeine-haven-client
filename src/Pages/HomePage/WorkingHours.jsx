...
const WorkingHours = () => {
  return (
    <div
      className="mt-[30px] md:mt-[50px] lg:mt-[90px] p-10 lg:p-[80px]"
      style={{
    ...
    >
      <div className="container mx-auto p-5 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="bg-third px-[40px] lg:px-[80px] py-[70px] mt-10 md:mt-0">
          <p className="font-body uppercase text-second text-center font-semibold">
            Monday to Friday
          </p>
          <p className="font-heading text-2xl text-white text-center mt-4">
            09 : 00
          </p>
          <p className="font-heading text-2xl text-white text-center">
            22 : 00
          </p>

          <p className="font-body uppercase text-second text-center font-semibold mt-8">
            Saturday to Sunday
          </p>
          <p className="font-heading text-2xl text-white text-center mt-4">
            11 : 00
