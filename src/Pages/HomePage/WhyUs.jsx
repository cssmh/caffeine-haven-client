    ...
    <div className="container mx-auto p-5 mt-5">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center gap-4 w-full md:w-2/3 lg:w-1/3 bg-third px-5 py-10 border-dotted border-lightBlack border-[1px] hover:shadow-[0_0_50px_#61616133] duration-300 self-stretch">
          ...
          <h3 className="text-3xl text-center font-heading">
            Menu for every taste
          </h3>
          <p className="text-lightWhite font-body text-center">
            Discover a menu tailored to satisfy every palate, where flavors
            harmonize to create a culinary symphony.
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center gap-4 w-full md:w-2/3 lg:w-1/3 bg-third px-5 py-10 border-dotted border-lightBlack border-[1px] hover:shadow-[0_0_50px_#61616133] duration-300 self-stretch">
          ...
          <p className="text-lightWhite font-body text-center">
            Every cup tells a story of excellence, ensuring a consistently
        ...
        <div className="flex flex-col justify-center items-center gap-4 w-full md:w-2/3 lg:w-1/3 bg-third px-5 py-10 border-dotted border-lightBlack border-[1px] hover:shadow-[0_0_50px_#61616133] duration-300 self-stretch">
          ...
          <p className="text-lightWhite font-body text-center">
            Experience culinary mastery with our seasoned chefs, crafting
            delectable dishes that redefine the art of flavor.
          </p>
        </div>
      </motion.div>
    </div>
