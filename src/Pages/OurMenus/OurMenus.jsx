...
const OurMenus = () => {
  ...
  const { allMenusPending, allMenus } = useAllMenus(
    selectedCategory,
    selectedOrigin
  );
  ...
  return (
    <div className="mx-auto mb-10">
      ...
      <div className="container mx-auto p-5 flex flex-col justify-center items-center gap-10">
        ...
        >
          {foodCategories.map((category, index) => (
            <button
              ...
              className={`text-white py-2 font-body ${
        ...
        {/* showing menu list */}
        {allMenus.length === 0 ? (
          <p className="text-2xl text-lightWhite text-center font-body mt-10">
            Oops! No item available!
          </p>
        ) : (
          <motion.div
