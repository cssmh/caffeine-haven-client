...
const AddNewItem = () => {
  ...
  return (
    <div className="mt-5 md:mt-7 lg:mt-10 w-full flex flex-col justify-center items-center gap-7">
      <h2 className="text-4xl uppercase font-heading text-center">
        Add new item
      </h2>
      ...
      >
        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-5 md:gap-8 lg:gap-14">
          ...
          <input
            ...
            className="w-full md:w-1/2 bg-[#00000000] border-b-[1px] py-3 border-lightBlack focus:outline-none focus:border-white text-white"
          />
          ...
          <select
            ...
            id="itemCategory"
            defaultValue={""}
            className="w-full md:w-1/2 bg-[#00000000] border-b-[1px] py-3 border-lightBlack focus:outline-none focus:border-white text-[#a2abb1] appearance-none"
          >
        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-5 md:gap-8 lg:gap-14">
          ...
          >
            ...
            {foodOriginList.map((origin, index) => (
              <option key={index} value={origin} className="capitalize">
                {origin}
              </option>
            ))}
          </select>
        ...
        <textarea
          ...
          maxLength={55}
          className="w-full bg-[#00000000] border-b-[1px] py-3 border-lightBlack focus:outline-none focus:border-white text-white"
        />
        ...
        >
          ...
          {selectedImageName.length > 25
            ...
            : selectedImageName || "Choose item's image"}
          <input
            type="file"
            name="image"
            id="image"
        ...
        <input
          type="submit"
          value="Add item"
          className="w-full bg-second text-white px-5 py-2 hover:bg-third duration-500 cursor-pointer font-medium"
        />
      </form>
    </div>
  );
